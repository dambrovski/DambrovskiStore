        ...
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="footer-about-us">
                    <h2>Dambrovski Store</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis sunt id doloribus vero quam laborum quas alias dolores blanditiis iusto consequatur, modi aliquid eveniet eligendi iure eaque ipsam iste, pariatur omnis sint! Suscipit, debitis, quisquam. Laborum commodi veritatis magni at?</p>
                    <div class="footer-social">
                        <a href="https://www.facebook.com/DambrovskiStore" target="_blank"><i class="fa fa-facebook"></i></a>
                        <a href="https://twitter.com/DambrovskiStore" target="_blank"><i class="fa fa-twitter"></i></a>
...
<div class="footer-bottom-area">
    <div class="container">
        <div class="row">
            <div class="col-md-8">
                <div class="copyright">
                    <p>&copy; 2020 - Dambrovski Github. <a href="https://github.com/dambrovski" target="_blank">https://github.com/dambrovski</a></p>
                </div>
            </div>
